    ...
    <div class="row text-center">
      <div class="col-12">
        <ul class="breadcrumb mb-0">
          ...
          <li class="active" style="color:'#000000'">Contact Us</li>
        </ul>
      </div>
      <div class="col-12">
        <h1>Contact Us</h1>
  ...
  <div class="container">
      ...
      <div class="bg-white shadow-md rounded h-100 p-3">
      	<div class="featured-box text-center">
              ...
              <h3>MoCardTransfert Inc.</h3>
              <p>440 Albert Street, C 109<br>
                Ottawa, Ontario<br>
                Canada<br>
                K1R 5B5.</p>
            </div>
      ...
      <p class="lead">Follow us on social media and get all update about kudi.</p>
